...
CREATE TABLE `darbuotojai` (
  ...
  `Vardas` varchar(128) COLLATE utf8mb4_general_ci NOT NULL,
  `projectID` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `darbuotojai` VALUES (1,'Stasys','1'),(2,'Žlugesys','2'),(3,'Justicija','2'),(4,'Deimantas','2'),(5,'Staselė','5'),(6,'Eldaras',NULL),(7,'Karpimantas',NULL),(8,'Saulius',NULL);
...
CREATE TABLE `projektai` (
  ...
  `projectName` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `projektai` VALUES (1,'Gerti'),(2,'Vaikščioti'),(3,'Miegoti'),(4,'Dirbti'),(5,'Eiti namo'),(6,'Bimbinėti'),(7,'Tinginiauti');
...
-- Dump completed on 2021-03-22 22:33:57
